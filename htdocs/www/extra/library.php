...
.book2 .page5 {
  background-image: url("../library/preview/book-2/page1.png");
  background-size: 100% 100%;
  background-repeat: no-repeat;
}

.book2 .page6 {
  background-image: url("../library/preview/book-2/page2.png");
  background-size: 100% 100%;
  background-repeat: no-repeat;
}
...
.book3 .page5 {
  background-image: url("../library/preview/book-3/page1.png");
  background-size: 100% 100%;
  background-repeat: no-repeat;
}

.book3 .page6 {
  background-image: url("../library/preview/book-3/page2.png");
  background-size: 100% 100%;
  background-repeat: no-repeat;
}
...
.book4 .page5 {
  background-image: url("../library/preview/book-4/page1.png");
  background-size: 100% 100%;
  background-repeat: no-repeat;
}

.book4 .page6 {
  background-image: url("../library/preview/book-4/page2.png");
  background-size: 100% 100%;
  background-repeat: no-repeat;
}
...
.book5 .page5 {
  background-image: url("../library/preview/book-5/page1.png");
  background-size: 100% 100%;
  background-repeat: no-repeat;
}

.book5 .page6 {
  background-image: url("../library/preview/book-5/page2.png");
  background-size: 100% 100%;
  background-repeat: no-repeat;
}
...
.book6 .page5 {
  background-image: url("../library/preview/book-6/page1.png");
  background-size: 100% 100%;
  background-repeat: no-repeat;
}

.book6 .page6 {
  background-image: url("../library/preview/book-6/page2.png");
  background-size: 100% 100%;
  background-repeat: no-repeat;
}

.book7 .page5 {
  background-image: url("../library/preview/book-7/page1.png");
  background-size: 100% 100%;
  background-repeat: no-repeat;
}

.book7 .page6 {
  background-image: url("../library/preview/book-7/page2.png");
  background-size: 100% 100%;
  background-repeat: no-repeat;
}
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
   ...
   <li class="nav-item">
			<a class="navbar-brand" href="./library.php">Общевоинская подготовка</a>
			</li>
   <li class="nav-item">
			<a class="nav-link" href="./library-special.php">Специальная подготовка</a>
			</li>
...
<div class="container" style="margin-top:70px">
  <div class="row">
	<div class="book1">
	<a style="display:block" href="../library/Медицинское_обеспечение.pdf">
	<div class="col-sm-4">
		<div class="book">
		  <div class="back"></div>
		  <div class="page6"></div>
	...
	<div class="book2">
	<a style="display:block; " href="../library/Общевоинские_Уставы_ВС_РФ.pdf">
	<div class="col-sm-4">
		<div class="book">
		  <div class="back"></div>
		  <div class="page6"></div>
		  ...
		  <div class="page1"></div>
		  <div class="front">
		  	<h4>Общевоинские Уставы ВС РФ</h4>
		  </div>
		</div>
	</div>
	</a>
...
<div class="book3">
	<a style="display:block; " href="../library/Огневая_подготовка.pdf">
	<div class="col-sm-4">
		<div class="book">
		  <div class="back"></div>
		  <div class="page6"></div>
		  ...
		  <div class="page1"></div>
		  <div class="front">
		  	<h4>Огневая подготовка из стрелкового оружия</h4>
		  </div>
		</div>
	</div>
	</a>
	...
	<div class="book4">
	<a style="display:block; " href="../library/Строевая_подготовка.pdf">
	<div class="col-sm-4">
		<div class="book">
		  <div class="back"></div>
		  <div class="page6"></div>
...
<div class="row">
	<div class="book5">
	<a style="display:block" href="../library/Общая_тактика.pdf">
	<div class="col-sm-4">
		<div class="book">
		  <div class="back"></div>
		  <div class="page6"></div>
	...
	<div class="book6">
	<a style="display:block; " href="../library/РХБЗ.pdf">
	<div class="col-sm-4">
		<div class="book">
		  <div class="back"></div>
		  <div class="page6"></div>
	...
	<div class="book7">
	<a style="display:block; " href="../library/Физическая_подготовка.pdf">
	<div class="col-sm-4">
		<div class="book">
		  <div class="back"></div>
		  <div class="page6"></div>
	...
	<div class="book4" style="visibility:hidden;">
	<a style="display:block; " href="../library/Строевая_подготовка.pdf">
	<div class="col-sm-4">
		<div class="book">
		  <div class="back"></div>
