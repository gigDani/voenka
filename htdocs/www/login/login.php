...
<html lang="en">
<head>
	<title>Форма авторизации ВУЦ СДО</title>
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="login.php" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="text" name="login" placeholder="Ваш логин" required>
					...
					<div class="container-login100-form-btn">
						<input class="inputsbm" name="do_login" type="submit" value="Войти" size="30px">
					</div>
					<div class="text-center p-t-90">
						<a class="txt1" href="#">
							Узнать свой пароль можно на кафедре ВУЦ
						</a>
					</div>
				</form>
			</div>
 ...
 if($user) {
 	...
 	if(password_verify($data['password'], $user->password)) {
 		...
 		// Редирект на главную страницу
                ...
                echo "<script>window.location.href='http://vuts-miit.ru/main_all.php';</script>";
