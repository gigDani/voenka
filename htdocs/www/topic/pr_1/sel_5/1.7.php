...
<div class="jumbotron text-center" style="margin-bottom:0">
  <h1>7.Меры безопасности при работах по выправке пути</h1>
    ...
    <div class="slider__wrapper">
     ...
     <br>
		<img src="img/t7/4.bmp"class="img-fluid">
	         ...
	         <div style="height: 1500px; background:#f0f8ff;">
     <br>
		<img src="img/t7/5.bmp"class="img-fluid">
		</div>
      </div>
	  	   <div class="slider__item">
	         <div style="height: 1500px; background:#f0f8ff;">
     <br>
		<img src="img/t7/6.bmp"class="img-fluid">
		</div>
      </div>
	  	   <div class="slider__item">
	         <div style="height: 1500px; background:#f0f8ff;">
     <br>
		<img src="img/t7/7.bmp"class="img-fluid">
		</div>
      </div>
